...
function postExpiratorMenuTabs($tab) {
	...
	if (empty($tab)) $tab = 'general';
        echo '<a href="'.admin_url('admin.php?page=policy-expiration&tab=general').'"'.($tab == 'general' ? ' style="font-weight: bold; text-decoration:none;"' : '').'>'.__('General Settings','post-expirator').'</a> | ';
        echo '<a href="'.admin_url('admin.php?page=policy-expiration&tab=defaults').'"'.($tab == 'defaults' ? ' style="font-weight: bold; text-decoration:none;"' : '').'>'.__('Defaults','post-expirator').'</a> | ';
        echo '<a href="'.admin_url('admin.php?page=policy-expiration&tab=diagnostics').'"'.($tab == 'diagnostics' ? ' style="font-weight: bold; text-decoration:none;"' : '').'>'.__('Diagnostics','post-expirator').'</a> | ';
	echo '<a href="'.admin_url('admin.php?page=policy-expiration&tab=viewdebug').'"'.($tab == 'viewdebug' ? ' style="font-weight: bold; text-decoration:none;"' : '').'>'.__('View Debug Logs','post-expirator').'</a>';
        echo '</p><hr/>';
}
	...
	?>
        <form method="post" id="postExpiratorMenuUpgrade">
                ...
                <table class="form-table">		
					...
					?>
                                        <br/>
					<a href="<?php echo admin_url('admin.php?page=policy-expiration&tab=viewdebug') ?>">View Debug Logs</a>
                                </td>
                        </tr>
                        <tr valign-"top">
